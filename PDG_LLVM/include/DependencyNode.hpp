...
public:
  ...
  void addDependencyFrom(DependencyNode<NodeT> *pNode, DependencyType type);
  const NodeT *getData() const { return dataNode; }
  DependencyLinkList &getDependencyList() { return dependencyList; }
  DependencyLinkList &getReverseDepList() {return reverseDepList;  }
...
private:
  ...
  DependencyLinkList reverseDepList;
};
