...
typename pdg::DependencyNode<pdg::InstructionWrapper>::DependencyLinkList pdg::DataDependencyGraph::getNodeReverseDepList(Instruction *inst)
{
  return DDG->getNodeReverseDepList(PDGUtils::getInstance().getInstMap()[inst]);
}
